...
public class ProductDetailsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Assuming you are fetching product details based on product id.
		...
		try {
			...
			e.printStackTrace();
		} // You need this method to get the product details

		// Set the product object in the request to make it available in the JSP

...
<body>
    ...
    <div class="cart-section" style="padding: 2rem;">
        <h2 style="text-align: center; font-size: 2rem; font-weight: bold; margin-bottom: 1rem; border-bottom: 2px solid #ccc; display: inline-block;">
            Your Shopping Cart
        </h2>
...
<tbody>
    <c:choose>
                ...
                <tr>
                    ...
                    <td style="padding: 1rem;">
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <a href="Cartquantity?action=dec&id=${cartItem.product.id}" class="btn btn-sm btn-decre">
                                <i class="fas fa-minus-square"></i>
                            </a>
                            <input type="text" value="${cartItem.quantity}" readonly style="width: 40px; text-align: center;">
                            <a href="Cartquantity?action=inc&id=${cartItem.product.id}" class="btn btn-sm btn-incre">
        ...
        <!-- Order Summary -->
        <div class="order-summary" style="margin-top: 3rem; padding: 1.5rem; border: 1px solid #eee; border-radius: 0.5rem; max-width: 400px;">
            <h3 style="font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">Order Summary</h3>
            ...
            <div style="display: flex; justify-content: space-between; font-weight: bold; color: #6A5ACD; font-size: 1.2rem; border-top: 1px solid #eee; padding-top: 0.5rem;">
                <span>Total</span>
                <span>$${cartTotal+5.0}</span>
            </div>

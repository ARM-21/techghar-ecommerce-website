...
.product-table .edit, .product-table .delete {
	text-decoration: none;
	font-size: 18px;
	margin-right: 10px;
}
		...
		<c:if test="${addNewProduct == true}">
			<div class="add-product-form">
				...
				<form method="post" action="save-product"
					...
					<!-- Image upload field -->
					<div class="form-group">
						<label for="imageUrl">Product Image</label> <input type="file"
				...
				<tbody>
					<c:forEach var="product" items="${products}">
						<tr>
							...
							<td>$${product.price}</td>
							<td>${product.stock}</td>
							<td><a href="admin-update?id=${product.id}" class="edit">✏️</a>

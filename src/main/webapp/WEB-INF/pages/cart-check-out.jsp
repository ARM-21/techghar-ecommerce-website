...
<div class="cart-section" style="padding: 2rem;">
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 2rem; justify-content: center;">
        ...
        <div style="flex: 1 1 500px; background-color: white; padding: 2rem; border-radius: 8px; box-shadow: var(--box-shadow);">
            <h3 style="font-size: 1.4rem; font-weight: bold; margin-bottom: 1.5rem;">Delivery Address</h3>
    ...
    <c:otherwise>
      <p> <a href="home" class="continue-shopping">Shop now</a></p>
    </c:otherwise>
  </c:choose>
 ...
 <%
        ...
        if (orderSuccess != null) {
            session.removeAttribute("orderSuccess"); // prevent repeat popup
    %>
        <script>
            alert("<%= orderSuccess %>");
        </script>
